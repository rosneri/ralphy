...
// seedWorktreeMcpConfig lives in ./worktree-mcp (kept out of this file to stay
// under the per-file line budget). Re-exported here so existing importers work.
export { seedWorktreeMcpConfig } from "./worktree-mcp";
