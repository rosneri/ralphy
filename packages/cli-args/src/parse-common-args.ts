...
import { emptyCommonArgs, type CliOverrides, type CommonArgs } from "./common-args";

/**
 * Argv-parsing machinery for the common CLI flag set. The widely-imported
 * types and `emptyCommonArgs` live in `./common-args`; these leaf parsers are
 * kept separate so the type surface stays small. Behavior is unchanged.
 */
