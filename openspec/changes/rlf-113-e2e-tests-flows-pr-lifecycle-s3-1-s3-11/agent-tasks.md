## Fix failing CI checks (2026-05-27T00:55:00.287Z)
...
Steps:
1. Inspect the failing checks: `gh pr checks https://github.com/NeriRos/ralphy/pull/282` then
...
4. Push with `git push origin ralph/rlf-113`. If the push is rejected as
   non-fast-forward, `git fetch origin ralph/rlf-113` then rebase before retrying.
...
PR: https://github.com/NeriRos/ralphy/pull/282
```
