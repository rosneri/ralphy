## Fix failing CI checks (2026-06-15T21:28:47.329Z)
...
Steps:
1. Inspect the failing checks: `gh pr checks https://github.com/rosneri/ralphy/pull/451` then
...
4. Push with `git push origin ralph/rlf-261`. If the push is rejected as
   non-fast-forward, `git fetch origin ralph/rlf-261` then `git merge origin/ralph/rlf-261`
