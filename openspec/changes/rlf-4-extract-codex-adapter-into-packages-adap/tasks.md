## Resolve PR merge conflicts (2026-05-14T19:18:22.129Z)
...
```
The PR https://github.com/NeriRos/ralphy/pull/123 has merge conflicts with `main`.
...
## Resolve PR merge conflicts (2026-05-14T19:08:07.620Z)
