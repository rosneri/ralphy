## Fix failing CI checks (2026-05-26T08:18:42.411Z)
...
Steps:
1. Inspect the failing checks: `gh pr checks https://github.com/NeriRos/ralphy/pull/259` then
...
4. Push with `git push origin ralph/rlf-157`. If the push is rejected as
   non-fast-forward, `git fetch origin ralph/rlf-157` then rebase before retrying.
...
PR: https://github.com/NeriRos/ralphy/pull/259
```
